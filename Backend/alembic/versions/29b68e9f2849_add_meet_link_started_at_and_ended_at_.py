"""add meet_link, started_at and  ended_at coloum in sessions table

Revision ID: 29b68e9f2849
Revises: fa795c7d2e51
Create Date: 2026-07-26 19:11:31.921125
...
revision: str = '29b68e9f2849'
down_revision: Union[str, Sequence[str], None] = 'fa795c7d2e51'
...
def upgrade() -> None:
    ...
    op.add_column('sessions', sa.Column('meet_link', sa.Text(), nullable=True))
